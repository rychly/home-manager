  ...
  "home-manager-install"
  {
    ...
    shellHook = ''
...

      {
        ...
        # configuration is compatible with. This helps void breakage
        # when a new Home Manager release introduces backwards
        # incompatible changes.
        #
        # Typically you do not need to change this value unless you
        # specifically need/want the latest changes. See the Home
        # Manager release notes for a list of changes in each release.
